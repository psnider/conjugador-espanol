...
export const verbos_con_cambios_morfológicos : {[infinitivo: string]: ReglasDeConjugaciónDeVerbo} = {
    abandonar:      { pronominal: true },
    abatir:         { pronominal: true },
    abolir:         { pronominal: false },    // FIX: abolir no se conjuga como abolo, aboles, abola, etc. Se usan perífrasis: va a abolir
    abrasar:        { pronominal: true },
    abrazar:        { pronominal: true },
    abreviar:       { pronominal: true },
    abrir:          { pronominal: true, excepciones_léxicas: { participio: ["abierto"] } },
    abrumar:        { pronominal: true },
    absolver:       { pronominal: false, alternancia_vocálica: "o:ue", excepciones_léxicas: { participio: ["absuelto"] } },
    absorber:       { pronominal: false },
    abstener:       { pronominal: true, modelo: "tener" },
    abundar:        { pronominal: false },
    aburrir:        { pronominal: true },
    acabar:         { pronominal: true, auxiliar: true },
    acaecer:        { pronominal: false, impersonal: "gramatical" },
    acampar:        { pronominal: true },
    acariciar:      { pronominal: false },
    acarrear:       { pronominal: false },
    acatar:         { pronominal: true },
    acceder:        { pronominal: false },
    acechar:        { pronominal: false},
    acelerar:       { pronominal: true },
    acentuar:       { pronominal: true },
    aceptar:        { pronominal: false },
    acercar:        { pronominal: true },
    acertar:        { pronominal: false, alternancia_vocálica: "e:ie" },
    achicar:        { pronominal: true },
    acicalar:       { pronominal: true },
    acoger:         { pronominal: true },
    acometer:       { pronominal: false },
    acompañar:      { pronominal: true },
    acondicionar:   { pronominal: true },
    acongojar:      { pronominal: true },
    aconsejar:      { pronominal: true },
    acontecer:      { pronominal: false, impersonal: "gramatical" },
    acordar:        { pronominal: true, alternancia_vocálica: "o:ue" },
    acortar:        { pronominal: true },
    acosar:         { pronominal: false },
    acostar:        { pronominal: true, alternancia_vocálica: "o:ue" },
    acostumbrar:    { pronominal: true },
    acreditar:      { pronominal: true },
    actualizar:     { pronominal: true },
    actuar:         { pronominal: true },
    acudir:         { pronominal: false },
    acumular:       { pronominal: false },
    acusar:         { pronominal: true },
    adaptar:        { pronominal: true },
    adelantar:      { pronominal: true },
    adelgazar:      { pronominal: true },
    adherir:        { pronominal: true, alternancia_vocálica: "e:ie" },
    adicionar:      { pronominal: false },
    adjudicar:      { pronominal: true },
    adjuntar:       { pronominal: false },
    admirar:        { pronominal: true },
    admitir:        { pronominal: false},
    adobar:         { pronominal: true },
    adorar:         { pronominal: false },
    adquirir:       { pronominal: false,
    ...
    adueñar:        { pronominal: true },
    advenir:        { pronominal: false, modelo: "venir" },
    advertir:       { pronominal: false, alternancia_vocálica: "e:ie" },
    afectar:        { pronominal: true },
    afeitar:        { pronominal: true },
    aferrar:        { pronominal: true },
    afirmar:        { pronominal: true },
    afligir:        { pronominal: true },
    aflojar:        { pronominal: true },
    aflorar:        { pronominal: false },
    afluir:         { pronominal: false },
    agachar:        { pronominal: true },
    agarrar:        { pronominal: true },
    agasajar:       { pronominal: false },
    agendar:        { pronominal: false },
    agitar:         { pronominal: true },
    agolpar:        { pronominal: true },
    agotar:         { pronominal: true },
    agradar:        { pronominal: true },
    agradecer:      { pronominal: false},
    agravar:        { pronominal: true },
    agredir:        { pronominal: false },   // FIX: Similar a abolir: falta presente de indicativo (excepto agredimos, agredís)
    agregar:        { pronominal: true },
    agrupar:        { pronominal: true },
    aguantar:       { pronominal: true },
    aguar:          { pronominal: true },
    agudizar:       { pronominal: true },
    ahijar:         { pronominal: false },
    ahitar:         { pronominal: true },
    ahorrar:        { pronominal: true },
    ahusar:         { pronominal: true },
    ahuyentar:      { pronominal: true },
    airar:          { pronominal: true },
    aislar:         { pronominal: true },
    ajustar:        { pronominal: true },
    alargar:        { pronominal: true },
    alarmar:        { pronominal: true },
    albergar:       { pronominal: true },
    alcanzar:       { pronominal: true },
    alcoholizar:    { pronominal: true },
    alegrar:        { pronominal: true },
    alejar:         { pronominal: true },
    alentar:        { pronominal: true, alternancia_vocálica: "e:ie" },
    alertar:        { pronominal: false },
    aliar:          { pronominal: true, modelo: "vaciar" },
    alimentar:      { pronominal: true },
    aliviar:        { pronominal: true },
    almorzar:       { pronominal: false, alternancia_vocálica: "o:ue" },
    alocar:         { pronominal: true },
    alojar:         { pronominal: true },
    alquilar:       { pronominal: true },
    // alquiler:    no es un verbo según el DEL de la RAE
    alterar:        { pronominal: true },
    alucinar:       { pronominal: true },
    alumbrar:       { pronominal: true },
    amaestrar:      { pronominal: true },
    amalgamar:      { pronominal: true },
    amanecer:       { pronominal: true, impersonal: "natural" },
    amar:           { pronominal: false},
    amarrar:        { pronominal: true },
    amasar:         { pronominal: true },
    amnistiar:      { pronominal: false, modelo: "vaciar" },
    amohinar:       { pronominal: true },
    amortiguar:     { pronominal: true },
    amparar:        { pronominal: true },
    ampliar:        { pronominal: false, modelo: "vaciar" },
    añadir:         { pronominal: false },
    anclar:         { pronominal: true },
    andar:          { pronominal: true, modelo: "andar",
                        auxiliar: true, 
    ...
    anhelar:        { pronominal: false },
    anidar:         { pronominal: true },
    animar:         { pronominal: true },
    aniquilar:      { pronominal: true },
    anochecer:      { pronominal: true, impersonal: "natural" },
    anotar:         { pronominal: false },
    ansiar:         { pronominal: true, modelo: "vaciar" },
    anticipar:      { pronominal: true }, 
    anticuar:       { pronominal: true },
    antojar:        { pronominal: true }, 
    anudar:         { pronominal: true },
    anunciar:       { pronominal: false },
    apacentar:      { pronominal: true, alternancia_vocálica: "e:ie" },
    apaciguar:      { pronominal: true },
    apagar:         { pronominal: true },
    aparar:         { pronominal: true },
    aparcar:        { pronominal: false },
    aparecer:       { pronominal: true },
    apartar:        { pronominal: true },
    apasionar:      { pronominal: true },
    apercibir:      { pronominal: true },
    apestar:        { pronominal: true },
    apetecer:       { pronominal: true },
    aplastar:       { pronominal: true },
    aplaudir:       { pronominal: false },
    aplicar:        { pronominal: true },
    apocopar:       { pronominal: false },
    apoderar:       { pronominal: true },
    apostar:        { alternancia_vocálica: "o:ue" },
    apreciar:       { pronominal: true },
    aprehender:     { pronominal: false },
    aprender:       { pronominal: false },
    apresar:        { pronominal: false },
    apresurar:      { pronominal: true },
    apretar:        { alternancia_vocálica: "e:ie" },
    aprobar:        { alternancia_vocálica: "o:ue" },
    aprovechar:     { pronominal: true },
    apuñalar:       { pronominal: true },
    apuntalar:      { pronominal: false },
    apuntar:        { pronominal: true },
    apurar:         { pronominal: true },
    aquilatar:      { pronominal: false },
    argüir:         { pronominal: false },
    argumentar:     { pronominal: true },
    armar:          { pronominal: true },
    arraigar:       { pronominal: true },
    arrancar:       { pronominal: true },
    arrasar:        { pronominal: true },
    arrastrar:      { pronominal: true },
    arreglar:       { pronominal: true },
    arremeter:      { pronominal: true },
    arrendar:       { pronominal: false, alternancia_vocálica: "e:ie" },
    arrepentir:     { pronominal: true, alternancia_vocálica: "e:ie" },
    arribar:        { pronominal: true },
    arriesgar:      {pronominal: true},
    arrimar:        {},
    arrojar:        {},
    arropar:        {},
    arrugar:        {},
    arruinar:       { pronominal: true },
    arrullar:       {},
    asaltar:        {},
    ascender:       { alternancia_vocálica: "e:ie" },
    asegurar:       { pronominal: true },
    asentar:        { alternancia_vocálica: "e:ie" },
    asentir:        { alternancia_vocálica: "e:ie" },
    asesinar:       {},
    asfixiar:       {},
    asignar:        {},
    asimilar:       { pronominal: true },
    asir:           { tema_presente_yo_del_modelo: ["asg"] },
    asistir:        {},
    asolar:         { alternancia_vocálica: "o:ue", acepta_regular: "variante" },
    asolear:        {},
    asomar:         { pronominal: true },
    asombrar:       { pronominal: true },
    aspirar:        {},
    asustar:        { pronominal: true },
    atacar:         {},
    atajar:         {},
    ...
    atemorizar:     {},
    atender:        { pronominal: false, alternancia_vocálica: "e:ie" },
    atenuar:        {},
    aterir:         {},   // FIX: Solo se usa en formas donde la raíz no lleva "i" tónica: atería, aterido; No se usa atero, ateres
    aterrar:        { pronominal: true, alternancia_vocálica: "e:ie" },
    aterrorizar:    { pronominal: true },
    atestiguar:     {},
    atiborrar:      {},
    atinar:         {},
    atorar:         {},
    atormentar:     { pronominal: true },
    atornillar:     {},
    atraer:         { modelo: "traer" },
    atrapar:        {},
    atravesar:      { pronominal: true, alternancia_vocálica: "e:ie" },
    atrever:        { pronominal: true },
    atribuir:       {},
    atrincherar:    { pronominal: true },
    atropellar:     {},
    aturdir:        { pronominal: true },
    auditar:        { pronominal: false },
    aullar:         {},
    aumentar:       {},
    aunar:          {},
    aupar:          {},
    auscultar:      {},
    autocensurar:   { pronominal: true },
    autoinfligir:   {},
    avenir:         { modelo: "venir" },
    aventajar:      { pronominal: true },
    aventurar:      { pronominal: true },
    avergonzar:     { alternancia_vocálica: "o:ue" },
    averiar:        { modelo: "vaciar" },
    averiguar:      {},
    avisar:         {},
    avivar:         { pronominal: true },
    avizorar:       {},
    ayudar:         {},
    azotar:         {},
    bailar:         {},
    ...
    bucear:         {},
    bullir:         {},
    burlar:         { pronominal: true },
    buscar:         { pronominal: true },
    caber:          { modelo: "caber",
    ...
    cagar:          { pronominal: true },
    calar:          { pronominal: true },
    calcular:       {},
    ...
    censurar:       { pronominal: false },
    centellear:     { pronominal: false },
    centrar:        {},
    cepillar:       {},
    cercar:         {},
    ...
    completar:      {},
    complicar:      { pronominal: true },
    componer:       { modelo: "poner" },
    comprar:        {},
    comprender:     {},
    comprobar:      { pronominal: false, alternancia_vocálica: "o:ue" },
    comprometer:    { pronominal: true },
    comunicar:      { pronominal: true },
    concebir:       { modelo: "pedir" },
    concentrar:     { pronominal: true },
    conceptuar:     {},
    ...
    confirmar:      { pronominal: true },
    confiscar:      { pronominal: false },
    confluir:       {},
    conformar:      {},
    confortar:      {},
    confundir:      {},
    ...
    conjurar:       {},
    conmover:       { pronominal: true, alternancia_vocálica: "o:ue" },
    conocer:        { modelo: "conocer", tema_presente_yo_del_modelo: ["conozc"] },
    conquerir:      { alternancia_vocálica: "e:ie" },
    conquistar:     { pronominal: false },
    conseguir:      { pronominal: false, alternancia_vocálica: "e:i" },
    consensuar:     {},
    ...
    contagiar:      {},
    contaminar:     {},
    contar:         { pronominal: true, alternancia_vocálica: "o:ue",
                      excepciones_léxicas: {
                            reglas: {
                                // FIX: try to use temas instead
    ...
    contemplar:     { pronominal: false },
    contender:      { alternancia_vocálica: "e:ie" },
    contener:       {},
    contestar:      {},
    continuar:      {},
    contraatacar:   { pronominal: false},
    contraer:       {},
    contrariar:     { modelo: "vaciar" },
    contrarrestar:  {},
    contratacar:    { pronominal: false},
    contratar:      {},
    contravenir:    { modelo: "venir" },
    contribuir:     { pronominal: false },
    controlar:      {},
    convencer:      { pronominal: true, tema_presente_yo_del_modelo: ["convenz"]},
    convenir:       { modelo: "venir" },
    conversar:      {},
    convertir:      { pronominal: true, alternancia_vocálica: "e:ie" },
    convivir:       {},
    cooperar:       { pronominal: false },
    corear:         {},
    corregir:       { alternancia_vocálica: "e:i" },
    correr:         {},
    corresponder:   {},
    corroer:        { modelo: "roer" },
    corromper:      { pronominal: true },
    cortar:         {},
    coser:          {},
    ...
    cuidar:         {},
    culpar:         {},
    cultivar:       { pronominal: true },
    cumplir:        { pronominal: true },
    curar:          { pronominal: true },
    currar:         {},
    custodiar:      {},
    dañar:          { pronominal: true },
    dar:            { modelo: "dar",
                        pronominal: true,
    ...
    debatir:        { pronominal: true },
    deber:          { auxiliar: true, pronominal: true },
    debilitar:      {},
    decaer:         {},
    decepcionar:    { pronominal: true },
    decidir:        {},
    decir:          { modelo: "decir", 
    ...
    declarar:       {},
    declinar:       {},
    dedicar:        { pronominal: true },
    defender:       { alternancia_vocálica: "e:ie" },
    deferir:        { alternancia_vocálica: "e:ie" },
    definir:        {},
    deformar:       {},
    degollar:       { alternancia_vocálica: "o:ue" },
    dejar:          { pronominal: true },
    delatar:        { pronominal: true },
    deleitar:       {},
    delinquir:      {},
    delirar:        {},
    demoler:        { alternancia_vocálica: "o:ue" },
    demonizar:      {},
    demorar:        { pronominal: true },
    demostrar:      { pronominal: false, alternancia_vocálica: "o:ue" },
    denegar:        { pronominal: true, alternancia_vocálica: "e:ie" },
    depender:       {},
    depositar:      {},
    depredar:       {},
    deprimir:       { pronominal: true },
    derivar:        {},
    derramar:       {},
    derretir:       { alternancia_vocálica: "e:i" },
    derribar:       {},
    derrotar:       { pronominal: true },
    derruir:        {},
    desaconsejar:   { pronominal: false },
    desactivar:     {},
    ...
    descansar:      {},
    descarar:       { pronominal: true },
    descargar:      {},
    descartar:      {},
    descender:      { alternancia_vocálica: "e:ie" },
    descifrar:      { pronominal: false },
    ...
    descubrir:      { pronominal: true, excepciones_léxicas: { participio: ["descubierto"] } },
    desdoblar:      {},
    desear:         {},
    desechar:       {},
    desembocar:     {},
    ...
    desvirtuar:     {},
    detallar:       {},
    detener:        { pronominal: true },    // FIX: setting modelo causes a failure, but it should work     {modelo: "tener"},
    deteriorar:     {},
    determinar:     {},
    devaluar:       {},
    devastar:       {},
    ...
    dibujar:        { pronominal: true },
    dictar:         { pronominal: false },
    diferenciar:    {},
    ...
    dignar:         {},
    diluir:         {},
    dirigir:        { pronominal: true },
    discernir:      { modelo: "cernir" },
    disciplinar:    {},
    disculpar:      { pronominal: true },
    diseñar:        {},
    disentir:       { alternancia_vocálica: "e:ie" },
    disfrazar:      {},
    disfrutar:      {},
    disgustar:      { pronominal: true },
    disimilar:      {},
    disimular:      {},
    disminuir:      {},
    ...
    distinguir:     { pronominal: true },
    distraer:       { pronominal: true },
    distribuir:     {},
    disuadir:       {},
    ...
    duchar:         {},
    dudar:          {},
    duplicar:       { pronominal: true },
    durar:          {},
    echar:          {},
    edificar:       {},
    educar:         { pronominal: false },
    efectuar:       {},
    efluir:         {},
    ejecutar:       { pronominal: false },
    ...
    emprender:      {},
    empujar:        {},
    enamorar:       { pronominal: true },
    encajar:        {},
    encaminar:      {},
    encantar:       { pronominal: false },
    encaramar:      {},
    encargar:       { pronominal: true },
    encender:       { alternancia_vocálica: "e:ie" },
    encerrar:       { alternancia_vocálica: "e:ie" },
    enchilar:       { pronominal: true },
    enchufar:       {},
    encoger:        {},
    encomendar:     { alternancia_vocálica: "e:ie" },
    encontrar:      { pronominal: true, alternancia_vocálica: "o:ue" },
    enderezar:      {},
    enfermar:       {},
    enflaquecer:    {},
    enfrentar:      {},
    enfriar:        { pronominal: true, modelo: "vaciar" },
    enfurecer:      { pronominal: true },
    engañar:        { pronominal: true },
    enganchar:      {},
    engordar:       {},
    engreír:        { modelo: "reír" },
    ...
    escarchar:      {},
    escoger:        {},
    escolar:        { alternancia_vocálica: "o:ue" },
    esconder:       { pronominal: true },
    escribir:       { excepciones_léxicas: { participio: ["escrito"] } },
    escuchar:       { pronominal: true },
    esculpir:       {},
    esforzar:       { alternancia_vocálica: "o:ue" },
    esfumar:        {},
    espantar:       {},
    esparcir:       { pronominal: true, tema_presente_yo_del_modelo: ["esparz"] },
    esperar:        { pronominal: false },
    espiar:         { modelo: "vaciar" },
    esquiar:        { modelo: "vaciar" },
    esquivar:       { pronominal: true },
    establecer:     { pronominal: true },
    estacionar:     {},
    estafar:        {},
    estallar:       {},
    estancar:       {},
    ...
    estudiar:       {},
    evadir:         {},
    evaluar:        { pronominal: false },
    evitar:         {},
    exacerbar:      {},
    exagerar:       { pronominal: false },
    examinar:       {},
    exasperar:      {},
    exceder:        { pronominal: true },
    exceptuar:      {},
    exclamar:       {},
    excluir:        {},
    exhalar:        {},
    exhibir:        { pronominal: true },
    exigir:         {},
    exiliar:        {},
    existir:        {},
    expandir:       {},
    ...
    explicar:       {},
    explorar:       {},
    explotar:       { pronominal: true },
    exponer:        {},
    expresar:       { pronominal: true },
    exprimir:       { pronominal: false },
    expulsar:       { pronominal: false },
    ...
    fumar:          {},
    funcionar:      {},
    fundar:         { pronominal: true },
    fundir:         {},
    ganar:          { pronominal: true },
    gastar:         {},
    gemir:          { modelo: "pedir" },
    generar:        {},
    germinar:       {},
    ...
    gotear:         { pronominal: false },
    gozar:          { pronominal: true },
    grabar:         { pronominal: true },
    graduar:        { pronominal: true },
    granizar:       { pronominal: false, impersonal: "natural" },
    gritar:         { pronominal: false },
    gruir:          { pronominal: false },
    gruñir:         { pronominal: false },
    guardar:        { pronominal: true },
    guiar:          { modelo: "guiar",
                        pronominal: true,
    ...
    guiñar:         { pronominal: true },
    guisar:         { pronominal: true },
    gustar:         { pronominal: false },
    haber:          { modelo: "haber",
                        pronominal: true,
    ...
    hermanar:       { pronominal: true },
    herrar:         { alternancia_vocálica: "e:ie" },
    hervir:         { alternancia_vocálica: "e:ie" },
    hilvanar:       {},
    hincar:         { pronominal: true },
    hipnotizar:     {},
    honrar:         { pronominal: true },
    hornear:        {},
    hospedar:       { pronominal: true },
    huir:           { /* se conjuga de forma regular, solo hay reglas especiales de ortografía */ },
    humanizar:      {},
    humillar:       {},
    hundir:         {},
    identificar:    { pronominal: true },
    ignorar:        { pronominal: false },
    igualar:        { pronominal: true },
    iluminar:       { pronominal: false },
    imaginar:       { pronominal: true },
    imbuir:         { pronominal: false },
    imitar:         {},
    impedir:        { pronominal: false, alternancia_vocálica: "e:i" },
    imperar:        { pronominal: false },
    implantar:      { pronominal: true },
    implicar:       {},
    implorar:       {},
    imponer:        {},
    importar:       { pronominal: false },
    imposibilitar:  {},
    ...
    insistir:       {},
    inspeccionar:   {},
    inspirar:       { pronominal: true },
    instalar:       { pronominal: true },
    instar:         {},
    instituir:      {},
    instruir:       {},
    instrumentar:   {},
    integrar:       {},
    intentar:       { pronominal: false },
    interactuar:    {},
    intercalar:     {},
    intercambiar:   {},
    interesar:      { pronominal: true },
    ...
    invitar:        { pronominal: false },
    involucrar:     { pronominal: true },
    inyectar:       { pronominal: false },
    ir:             { modelo: "ir",
                        auxiliar: true,
                        no_admite_prefijos: true,
    ...
    irritar:        { pronominal: true },
    iterar:         {},
    jactar:         {},
    jalar:          { pronominal: false },
    jaquear:        { pronominal: false },
    josear:         {},
    jubilar:        {},
    ...
    levantar:       { pronominal: true },
    levitar:        { pronominal: false },
    lexicalizar:    { pronominal: true },
    liberar:        { pronominal: false },
    licenciar:      { pronominal: true },
    lidiar:         { pronominal: true }, 
    ligar:          {},
    limpiar:        {},
    llamar:         { pronominal: true },
    llegar:         {},
    llenar:         {},
    llevar:         { pronominal: true },
    llorar:         {},
    ...
    mantener:       {},
    maquillar:      { pronominal: true },
    marcar:         { pronominal: true },
    marchar:        {},
    martillar:      {},
    masajear:       {},
    mascar:         {},
    ...
    mostrar:        { pronominal: true, alternancia_vocálica: "o:ue" },
    motivar:        { pronominal: true },
    ...
    nadar:          {},
    navegar:        { pronominal: false },
    necesitar:      { pronominal: false },
    negar:          { pronominal: true, alternancia_vocálica: "e:ie" },
    ...
    obedecer:       {},
    obligar:        {},
    obrar:          { pronominal: false },
    obsequiar:      {},
    observar:       {},
    obstruir:       {},
    obtener:        { pronominal: false, modelo: "tener" },
    ocasionar:      {},
    ocluir:         {},
    ocultar:        { pronominal: true },
    ocupar:         {},
    ocurrir:        {},
    odiar:          {},
    ofrecer:        {},
    ...
    oponer:         { modelo: "poner"},
    optimizar:      {},
    ordenar:        { pronominal: true },
    organizar:      { pronominal: true },
    originar:       {},
    orinar:         {},
    padecer:        {},
    pagar:          {},
    parar:          {},
    parecer:        {},
    parpadear:      { pronominal: false },
    participar:     {},
    partir:         {},
    partyar:        {},
    pasar:          { pronominal: true },
    pasear:         {},
    pasmar:         {},
    patear:         {},
    patinar:        {},
    ...
    percatar:       { pronominal: true },
    perder:         { alternancia_vocálica: "e:ie" },
    perdonar:       {},
    perfeccionar:   {},
    perforar:       {},
    perjudicar:     {},
    permanecer:     { pronominal: false },
    permitir:       { pronominal: true },
    perpetrar:      {},
    perpetuar:      {},
    perseguir:      { alternancia_vocálica: "e:i" },
    persuadir:      { pronominal: true },
    pertenecer:     {},
    perturbar:      { pronominal: true },
    ...
    preguntar:      { pronominal: true },
    prender:        {},
    preocupar:      { pronominal: true },
    preparar:       {},
    presenciar:     {},
    presentar:      {},
    presentir:      { alternancia_vocálica: "e:ie" },
    presionar:      { pronominal: false },
    prestar:        {},
    presumir:       { pronominal: false },
    pretender:      {},
    ...
    pulir:          {},
    puntuar:        {},
    quebrantar:     { pronominal: true },
    quebrar:        { pronominal: true, alternancia_vocálica: "e:ie" },
    quedar:         { pronominal: true },
    quejar:         { pronominal: true },
    quemar:         { pronominal: true },
    ...
    quitar:         { pronominal: true },
    radicar:        {},
    ramificar:      {},
    raspar:         {},
    rastrear:       {},
    razonar:        { pronominal: false },
    realizar:       {},
    reanudar:       {},
    rearmar:        {},
    rebanar:        {},
    rebasar:        { pronominal: false },
    rebelar:        {},
    rebosar:        {},
    recetar:        {},
    rechazar:       { pronominal: false },
    rechinar:       {},
    recibir:        {},
    reciclar:       {},
    reclamar:       {},
    ...
    recoger:        {},
    recolectar:     {},
    recomendar:     { pronominal: true, alternancia_vocálica: "e:ie" },
    ...
    recorrer:       {},
    recriminar:     { pronominal: true },
    rectificar:     { pronominal: true },
    recuperar:      { pronominal: true },
    recurrir:       {},
    redistribuir:   {},
    redituar:       {},
    reducir:        { pronominal: true },
    reeditar:       { pronominal: false },
    reemplazar:     {},
    reenamorar:     { pronominal: true },
    reencontrar:    { pronominal: true, alternancia_vocálica: "o:ue" },
    reenviar:       { modelo: "vaciar" },
    reevaluar:      {},
    referir:        { alternancia_vocálica: "e:ie" },
    reflejar:       {},
    reflexionar:    { pronominal: false },
    refluir:        {},
    reformar:       {},
    reforzar:       { alternancia_vocálica: "o:ue" },
    refugiar:       {},
    refutar:        {},
    regalar:        { pronominal: true },
    regañar:        {},
    regar:          { pronominal: true, alternancia_vocálica: "e:ie" },
    regir:          { pronominal: true, alternancia_vocálica: "e:i" },
    registrar:      {},
    regresar:       {},
    regular:        {},
    ...
    rejuvenecer:    {},
    relacionar:     { pronominal: true },
    relajar:        {},
    relampaguear:   {},
    relucir:        { modelo: "lucir" },
    remar:          { pronominal: false },
    rememorar:      {},
    ...
    remplazar:      {},
    rencontrar:     { pronominal: true, alternancia_vocálica: "o:ue" },
    renderizar:     { pronominal: true },
    rendir:         { modelo: "pedir", pronominal: true },
    reñir:          { alternancia_vocálica: "e:i" },
    renovar:        { alternancia_vocálica: "o:ue" },
    renunciar:      { pronominal: false },
    reparar:        {},
    repartir:       {},
    repasar:        {},
    repercutir:     {},
    repetir:        { pronominal: true, alternancia_vocálica: "e:i" },
    replicar:       {},
    reposar:        {},
    representar:    {},
    reprimir:       {},
    reprobar:       { pronominal: false, alternancia_vocálica: "o:ue" },
    requerir:       { pronominal: false, alternancia_vocálica: "e:ie" },
    resaltar:       { pronominal: false },
    resbalar:       {},
    resentir:       { alternancia_vocálica: "e:ie" },
    resfriar:       { modelo: "vaciar" },
    residir:        { pronominal: false },
    resistir:       { pronominal: true },
    resollar:       { alternancia_vocálica: "o:ue" },
    resolver:       { modelo: "mover", excepciones_léxicas: {participio: ["resuelto"]} },
    respetar:       {},
    respirar:       { pronominal: false },
    resplandecer:   { pronominal: false },
    responder:      { pronominal: false },
    restar:         { pronominal: false },
    restaurar:      {},
    restituir:      {},
    restringir:     {},
    resultar:       {},
    ...
    revisar:        {},
    revolver:       { modelo: "volver", pronominal: true },
    rezagar:        {},
    rimar:          { pronominal: false },
    robar:          {},
    ...
    rogar:          { pronominal: false, alternancia_vocálica: "o:ue" },
    romper:         { pronominal: true, excepciones_léxicas: { participio: ["roto"] } },
    rondar:         {},
    rozar:          {},
    rugir:          {},
    saber:          { modelo: "saber",
    ...
    señalar:        { pronominal: true },
    sentar:         { pronominal: true, alternancia_vocálica: "e:ie" },
    sentenciar:     { pronominal: false },
    sentir:         { pronominal: true, alternancia_vocálica: "e:ie" },
    separar:        { pronominal: true },
    ser:            { modelo: "ser",
                        auxiliar: true,
                        no_admite_prefijos: true,
                        tema_pretérito_del_modelo: "fu",
    ...
    sobrellevar:    { pronominal: false },
    sobrepasar:     { pronominal: false },
    sobresalir:     { pronominal: false },
    ...
    solicitar:      { pronominal: false },
    sollozar:       { pronominal: false },
    soltar:         { pronominal: true, alternancia_vocálica: "o:ue" },
    solucionar:     { pronominal: true },
    someter:        {},
    sonar:          { alternancia_vocálica: "o:ue" },
    soñar:          { alternancia_vocálica: "o:ue" },
    sonreír:        { modelo: "reír" },
    sonrojar:       { pronominal: true },
    soportar:       {},
    sorprender:     {},
    sortear:        {},
    sosegar:        { alternancia_vocálica: "e:ie" },
    sospechar:      {},
    sostener:       { pronominal: true },
    soterrar:       {},
    suavizar:       {pronominal: true},
    subir:          {},
    substituir:     {},
    substraer:      {},
    ...
    sujetar:        {},
    sumar:          {},
    sumergir:       { pronominal: true },
    suministrar:    { pronominal: false },
    superar:        { pronominal: true },
    suplicar:       {},
    suplir:         {},
    suponer:        {},
    suprimir:       { pronominal: false },
    supurar:        {},
    surgir:         {},
    suscitar:       {},
    ...
    sustituir:      {},
    sustraer:       {},
    susurrar:       { pronominal: true },
    tachar:         { pronominal: false },
    tallar:         {},
    tambalear:      {},
    tañer:          {},
    tapar:          {},
    tapiar:         {},
    tararear:       {},
    tardar:         { pronominal: true },
    tartamudear:    {},
    tatuar:         { pronominal: true },
    teclear:        { pronominal: false },
    temblar:        { alternancia_vocálica: "e:ie" },
    temer:          { pronominal: true },
    templar:        {},
    ...
    volcar:         { pronominal: true, alternancia_vocálica: "o:ue" },
    voltear:        { pronominal: true },
    volver:         { modelo: "volver", alternancia_vocálica: "o:ue", excepciones_léxicas: { participio: ["vuelto"] } },
    vomitar:        {},
    vosear:         { pronominal: true },
    votar:          {},
