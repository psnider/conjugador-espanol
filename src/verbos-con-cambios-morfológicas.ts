import { GrammaticalPerson, StemChangeRuleId, MoodTense, MoodTenseMap, VerbConjugation, VerbConjugationAnnotation, VerbConjugationChanges, ConjugationOrDerivation, Participios, FormaConjugada, StemChangeFamily, IrregularYRegular } from "."
