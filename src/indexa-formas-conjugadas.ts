...
const indices = generaIndiceDeFormasConjugadas()
...
export function encuentraFormasSimilares(consulta: string) : {infinitivos: string[], formas: {[forma: string]: FormaID[]} } {
    ...
    const formas: {[forma: string]: FormaID[]} = {}
